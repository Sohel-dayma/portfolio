'use client'
const WHATSAPP_NUMBER  = '919726632402'
const WHATSAPP_MESSAGE = 'Hi! I visited your portfolio and would like to connect.'
...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <span className="
        whitespace-nowrap font-semibold text-sm pl-4
